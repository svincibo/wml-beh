...
if exist(fullfile(saveDir, ['test_sub' num2str(prefs.subID) '_day4.mat']), 'file') == 2
    ...
    clear ch ch2
elseif exist(fullfile(saveDir, ['test_sub' num2str(prefs.subID) '_day3.mat']), 'file') == 2
    prefs.day = 4; flag = 0;
elseif exist(fullfile(saveDir, ['test_sub' num2str(prefs.subID) '_day2.mat']), 'file') == 2
    prefs.day = 3; flag = 0;
elseif exist(fullfile(saveDir, ['test_sub' num2str(prefs.subID) '_day1.mat']), 'file') == 2
    prefs.day = 2; flag = 0;
else
    prefs.day = 1; flag = 0;
end
...
copyfile(fullfile(saveDir, ['test_sub' num2str(prefs.subID) '_day' num2str(prefs.day) '.mat']), fullfile(localDir, 'data'))
copyfile(fullfile(saveDir, ['test_sub' num2str(prefs.subID) '_day' num2str(prefs.day) '.txt']), fullfile(localDir, 'data'))
