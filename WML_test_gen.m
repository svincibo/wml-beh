...
if issueflag
    outputfile = fopen([saveDir '/sub' num2str(prefs.subID) '_test_gen_day' num2str(prefs.day) '_' datestr(now,'mm-dd-yyyy_HH-MM') '.txt'],'a');
else
...
if issueflag
    save(fullfile(saveDir, ['sub' num2str(prefs.subID) '_test_gen_day' num2str(prefs.day) '_' datestr(now,'mm-dd-yyyy_HH-MM') '.mat']))
else
...
copyfile(fullfile(saveDir, ['sub' num2str(prefs.subID) '_test_gen_day' num2str(prefs.day) '*.mat']), fullfile(localDir, 'data'))
copyfile(fullfile(saveDir, ['sub' num2str(prefs.subID) '_test_gen_day' num2str(prefs.day) '*.txt']), fullfile(localDir, 'data'))
